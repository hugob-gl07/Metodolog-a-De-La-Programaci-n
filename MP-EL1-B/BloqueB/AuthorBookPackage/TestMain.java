...
public class TestMain {
    public static void main(String[] args) { /** creamos esta clase Main donde le daremos a cada variable un valor y pediremos que se imprima tanto el toString como las variables por separado */
