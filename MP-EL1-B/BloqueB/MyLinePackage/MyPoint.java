...
public class MyPoint {/** creamos la clase mypoint e indicamos sus puntos x,y en el plano */
    ...
    public int getX() { return x; }/** usamos getters y setters para avanzar y obtener los datos de las variables*/
    public void setX(int x) { this.x = x; }
    public int getY() { return y; }
    public void setY(int y) { this.y = y; }

    // Este es el que te faltaba para que funcione getBeginXY y similares
    public int[] getXY() {
        return new int[] {this.x, this.y};
    }

    // Este también es necesario para los setters combinados
